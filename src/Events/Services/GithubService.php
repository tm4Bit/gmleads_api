...
class GithubService implements GithubServiceInterface
{
    ...
    public function __construct(private HttpClient $httpClient, private LoggerInterface $logger)
    {
    ...
    {
        $url = sprintf( 'repos/%s/%s/contents/%s', $this->config['owner'], $this->config['repo'], $filePath);
